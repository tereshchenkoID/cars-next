      ...
      <div className={style.content}>
        ...
        <ul className={style.list}>
          <li className={style.option}>
            ...
            />
            <p>{data.mileage_data.mileage} ({t(`filters.mileage_unit.${data.mileage_data.mileage_unit.id}`)})</p>
          </li>
          <li className={style.option}>
            <Icon
              iconName={'calendar'}
          ...
          <li className={style.option}>
            <Icon
              ...
              className={style.icon}
            />
            <p>{data.power_data.power} ({t(`filters.power_unit.${data.power_data.power_unit.id}`)})</p>
          </li>
          <li className={style.option}>
            <Icon
